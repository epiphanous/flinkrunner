...
replacing `<flinkrunner-version>` with the currently released version of [flinkrunner on maven](https://mvnrepository.com/artifact/io.epiphanous/flinkrunner_2.12).
