...
val V = new {
  ...
  val jdbcPg              = "42.6.0"
  val jna                 = "5.13.0" // needed for testcontainers in some jvms
  val logback             = "1.4.8"
  val parquet             = "1.13.1"
...
val flinkDeps =
  Seq(
    ...
    "org.apache.flink"  % "flink-connector-jdbc"                 % s"3.1.1-${V.flinkMinor}" % Provided,
...
val otherDeps = Seq(
  ...
  "com.github.pjfanning"            %% "jackson-scala-reflect-extensions"       % "2.15.0",
